...
<div class="featured_content" id="feature" style="height: 600px">
    ...
    <div class="row text-center">
        ...
        <div class="col-md-12" style="margin-top: 10px;">
            ...
            <div style="width: 100%; text-align: right; color: green; font-size: 18px; font-weight: bold">AGREGAR BANNERS</div>
            <div style="width: 100%; text-align: right; color:navy; font-size: 14px;">
                <a href="" onclick="history.back();">VOLVER...</a>
            </div>
            
            <br><br>
            <form method="post" action="../controlador/FrontController.php?action=nuevobanner" enctype="multipart/form-data">
                    <table border="0" style="margin-left: auto; margin-right: auto; max-width: 90%">
                        <tr style="height: 40px">
                            
                            <td style="text-align: right">
                                <label style=" font-family: arial; font-size: 12px; font-weight: bold">RUTA</label>
                            </td>
                            
                            <td style="text-align: left; padding-left: 10px">
                                <input type="file" name="objFile" style="width: 90%">
                            </td>
                        </tr>
                        ...
                        <tr style=" height: 40px">
                            ...
                            <td style="text-align: left; padding-left: 10px">
                                <input type="text" class="text" name="descripcionImagen" style=""/>
                            </td>
                        </tr>
