...
<div class="featured_content" id="feature" style="height: 600px">
    ...
    <div class="row text-center">
        ...
        <div class="col-md-12" style="margin-top: 10px;">
            ...
            <br><br>
            <?php
                echo '<form method="post" action="../controlador/FrontController.php?action=cambioImagenPrincipal&lineaNegocio='.$_GET['lineaNegocio'].'" enctype="multipart/form-data">';
            ?>
