    ...
    <div class="row text-center">
        ...
        <div class="col-md-12" style="margin-top: 100px">
            ...
            <div style="width: 565px; height: 202px; background-color: white; margin-left: auto; margin-right: auto">
                ...
                <div id="imagen">
                    <img src="img/success.png" style="width: 130px; margin-top: 30px">
                </div>
                ...
                <div>
                    ...
                    <div id="escrito">
                        <span style="font-family:arial; font-size: 14px; font-weight: bold">
                            EL CORREO FUE ENVIADO EXITOSAMENTE.<br>TAN PRONTO NOS SEA POSIBLE NOS COMUNICAREMOS CON USTED. <br><br><br>
                        </span>
