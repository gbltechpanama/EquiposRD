...
<div class="featured_content" id="feature" style="height: 600px">
    ...
    <div class="row text-center">
        ...
        <div class="col-md-12" style="margin-top: 10px;">
            ...
            <form method="post" action="../controlador/FrontController.php?action=integradores">
                    <table border="0" style="width: 90%; margin-left: auto; margin-right: auto;">
                        <tr style=" height: 40px">
                            <td style="text-align: right">
                                <label style=" font-family: arial; font-size: 12px; font-weight: bold">LINEA DE NEGOCIO:</label>
                            </td>
                            <td style="text-align: left; padding-left: 10px">
                                <select name="lineaNegocio" style="min-width: 200px">
                                    <?php
                                    
                                    $n = count($_SESSION['todasLineasNegocio']);
                                    
                                    
                                    for ($i=0; $i<$n; $i++) {
                                        echo '<option>'.$_SESSION['todasLineasNegocio'][$i].'</option>';
                                    }
